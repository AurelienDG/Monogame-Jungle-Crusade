...
namespace jeu_monogame_SAE
{
...

    {
        ...
        public Jeu2(Game1 game) : base(game)
        {
            _myGame = game;
        ...
        public override void Initialize()
        {
            ...
            _posPango = new Vector2(901, 710);
            _posBat = new Vector2(848, 487);
        ...
        public override void LoadContent()
        {
            ...
            _perso = new Sprite(new AnimatedSprite(spriteSheet), new Vector2(50, 62));
            ...
            //charger la map
            _tiledMap = Content.Load<TiledMap>("LaMAP2");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            rectZonePango = new Rectangle(387, 640, 990, 95);
            rectPorte = new Rectangle(1568, 192, 36, 96);
            rectZoneBat = new Rectangle(576, 448, 545, 95);

            if (_vie.InfoVie() <= 0 || _perso.Position().Y > 900)
            {
                _myGame.LoadScreen2();
                _myGame._currentScreen = Ecran.GameOver;
            }
            ...
            {
                _myGame.LoadScreen5();
                _myGame._currentScreen = Ecran.Victory;
            }
